      ...
      <div class="container">
        ...
        <div class="tab-content" data-aos="fade-up">
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <n2 >ASSAM CONFIRMED<h2>
                  <n2 id="dc"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>ASSAM RECOVERED<h2>
                  <n2 id="dr"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>ASSAM DEATHS<h2>
                  <n2 id="dd"><h2></li>
                </ul>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Clinics  & Testing centers in ASSAM</h3>
                
                <p class="font-italic">
                  List of government approved testing centers
                <ul>
                  <li><i class="ri-check-double-line"></i>Fakkhruddin Ali Ahmed Medical College.Barpeta</li>
                  <li><i class="ri-check-double-line"></i> Gauhati Medical College, Guwahati</li>
                  <li><i class="ri-check-double-line"></i>Jorhat Medicat College,Jorhat</li>
                  <li><i class="ri-check-double-line"></i> Regional Medical Research Center,Dibrugarh </li>
                  <li><i class="ri-check-double-line"></i> Silchar Medical College,Silchar</li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
...
Array.prototype.sum = function (prop) {
    ...
    var DelhiConfirmed = covid_data[4].districtData.sum("confirmed");
    document.getElementById("dc").innerHTML = DelhiConfirmed
    var DelhiDeceased = covid_data[4].districtData.sum("deceased");
    document.getElementById("dd").innerHTML = DelhiDeceased
        var DelhiRecovered = covid_data[4].districtData.sum("deceased");
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                 <?php
                                  $query = "SELECT * FROM healthcare WHERE state='assam'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN ASSAM</h1>
  <br><br>
  <CENTER>
  <div ><a href="https://nhm.assam.gov.in/sites/default/files/swf_utility_folder/departments/nhm_lipl_in_oid_6/portlet/level_2/cat_ii_covid_hospital_10th_may_2020.pdf">
